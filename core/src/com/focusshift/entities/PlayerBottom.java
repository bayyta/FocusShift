...
public class PlayerBottom {
	...
	public PlayerBottom(AssetLoader assetloader, World world) {
		this.assetloader = assetloader;
		// player
		BodyDef bdef = new BodyDef();
		bdef.position.set((FocusShift.WIDTH / 2) / PPM, 600 / PPM);
	...
	public void render(SpriteBatch sb) {
		// sb.draw(assetloader.options, body.getPosition().x * PPM - assetloader.options.getRegionWidth() / 2, body.getPosition().y * PPM - assetloader.options.getRegionHeight() / 2);
	}
